...
void ws_fix_copy(struct strbuf *dst,
		 const char *src, int len,
		 unsigned ws_rule, int *error_count)
{
	/*
	 ...
	 * Incomplete line.
	 *
	 * NEEDSWORK: apply.c needs to be updated to combine the
	 * payload line plus "\ No newline" line into one line that
	 * lacks the terminating newline before calling this function.
	 */
