...
git stash reword [(-m | --message) <message>] [<stash>]
...
`reword [(-m | --message) <message>] [<stash>]`::
	Change the description of the stash entry. If no `<message>` is
	provided, launch the editor to write a new message.
